					...
					<table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
						<thead>
							<tr>
								...
								<th class="border-bottom-0">تـأريخ الاستحقــاف</th>
						...
						<tbody>
							...
							@foreach ($balances as $balance)
								...
								<tr>
									...
									<td>{{ $balance->type }}</td>
									<td>{{ $balance->state }}</td>
									<td>{{ Str::substr($balance->date, 0, 10) }}</td>
									<td>
										<a class=" btn btn-sm btn-info"  href="{{route('balance.edit',$balance->id)}}" title="تعديل"><i class="las la-pen"></i></a>
									{{-- <!-- @endcan --> --}}

									{{-- <!-- @can('حذف قسم') --> --}}
									<a class=" btn btn-sm btn-danger"  href="{{route('balance.destroy',$balance->id)}}" title="حذف"><i class="las la-trash"></i></a>
