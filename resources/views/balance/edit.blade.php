...
<div class="breadcrumb-header justify-content-between">
	<div class="my-auto">
		<div class="d-flex">
			<h4 class="content-title mb-0 my-auto">رصيد الموظفين</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تعديل</span>
		</div>
	</div>
</div>
<!-- breadcrumb -->
			...
			<div class="card-body">
				<form action="{{route('balance.update')}}" method="post">
					...
					<div class="row">
						...
						<div class="col">
							<label for="inputName" class="control-label">المبلـغ</label>
							<input type="number" class="form-control" id="inputName" name="amount"
								title="المبلـغ" required value="{{$balance->amount}}">
						</div>

						<label class="my-1 mr-2" for="inlineFormCustomSelectPref">التأكيـد</label>
                            <select name="state" id="section_id" class="form-control" required>
                                <option value="0">لا</option>
                                <option value="1">نعـم</option>
                            </select>

					</div>
					<div class="row">
						<div class="col">
							<label class="my-1 mr-2" for="inlineFormCustomSelectPref">نوع العملية</label>
						...
						<div class="col">
							<label for="inputName" class="control-label"> تـأريخ الاستحقــاف</label>
