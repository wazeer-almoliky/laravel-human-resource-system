...
<div class="breadcrumb-header justify-content-between">
	<div class="my-auto">
		<div class="d-flex">
			<h4 class="content-title mb-0 my-auto">موظف</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ اضافــة</span>
		</div>
	</div>
</div>
<!-- breadcrumb -->
		...
		<div class="card">
			<div class="card-body">
				...
				@csrf
					...
					<br><br>
					<div class="d-flex justify-content-center flex-groe-2">
