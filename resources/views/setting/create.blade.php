...
<div class="breadcrumb-header justify-content-between">
	<div class="my-auto">
		<div class="d-flex">
			<h4 class="content-title mb-0 my-auto">هيكل بيئة النظام</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ اضافــة</span>
		</div>
	</div>
</div>
<!-- breadcrumb -->
				...
				<form action="{{route('setting.store')}}" method="post">
					...
					<div class="row">
						<div class="col">
							...
							<input type="number" class="form-control" id="inputName" name="hour"
								title="عدد ساعات العمل" required>
						</div>

						<div class="col">
							<label for="inputName" class="control-label">بداية وقت العمل</label>
							<input type="number" class="form-control" id="inputName" name="start"
								title="بداية وقت العمل" required>
						</div>

						<div class="col">
							<label for="inputName" class="control-label">نهايـة وفت العمل</label>
							<input type="number" class="form-control" id="inputName" name="end"
								title="نهايـة وفت العمل" required>
						</div>
					...
					<div class="row">
						<div class="col">
							...
							<input type="number" class="form-control" id="inputName" name="after_count_time"
								title="يتم تسجيل وفت الحظور من بعد" required>
						</div>
